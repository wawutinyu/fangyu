...
DEFAULT_MATERIALS: dict[str, Any] = {
    ...
    "tools": [
        ...
        {"id": "browser_wait", "source": "builtin", "belts": ["coding"]},
        {"id": "browser_scroll", "source": "builtin", "belts": ["coding"]},
        {"id": "browser_press", "source": "builtin", "belts": ["coding"]},
        {"id": "browser_screenshot", "source": "builtin", "belts": ["coding"]},
    ...
    "roles": [
        ...
        },
        {
            ...
            "tools": [
                ...
                "browser_type", "browser_wait", "browser_scroll",
                "browser_press", "browser_screenshot",
            ],
        },
        {
            "id": "review",
